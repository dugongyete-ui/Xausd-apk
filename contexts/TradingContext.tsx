...
function findSwings(
  ...
  if (trend === "Bearish") {
    for (let i = n - 4; i >= 4; i--) {
      ...
      // Cari 3-bar local low dari dekat anchor ke belakang; fallback ke min 20 candle.
    ...
    for (let i = n - 4; i >= 4; i--) {
      ...
      // Cari 3-bar local high dari dekat anchor ke belakang; fallback ke max 20 candle.
      const searchStart = Math.max(1, i - PAIR_LOOKBACK);
